...
class Flickr(NodeDataset):
    def __init__(self, name="Flickr", root="./", split="official"):
        super(Flickr, self).__init__(root + "Flickr", name, k=None)
    ...
    def raw_file_paths(self):
        filenames = ['adj_full.npz', 'feats.npy',
                     'class_map.json', 'role.json']
    ...
    def process(self):
        features = np.load(osp.join(self.raw_dir, 'feats.npy'))
